...
// Enhanced mockGitHubApi with missing methods
Object.assign(mockGitHubApi, {
  mockUserSuccess() {
  ...
  mockApiError(status, message = 'API Error') {
  ...
  mockFileContentSuccess(content = 'test content') {
    global.fetch.mockResolvedValueOnce({
      ok: true,
      status: 200,
      json: () =>
